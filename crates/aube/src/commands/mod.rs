...
pub(crate) use settings_context::{
    ...
    global_frozen_override, global_output_flags, global_virtual_store_flags, load_npm_config,
    make_client, open_store, packument_cache_dir, packument_full_cache_dir, project_modules_dir,
    resolve_fetch_policy, resolve_lockfile_kind_for_write, resolve_modules_dir_name_for_cwd,
