...
/// process with the diagnostic-specific exit code on failure — it only
/// returns on success. Embedders driving commands programmatically should
/// call into [`commands`] directly instead.
pub fn cli_main() {
