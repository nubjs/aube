...
impl Store {
    ...
    pub fn import_tarball_reader<R: std::io::Read>(
        ...
        let pipelined_disabled = aube_util::env::var_os("AUBE_DISABLE_PIPELINED_IMPORT").is_some();
        let parallel_disabled = aube_util::env::var_os("AUBE_DISABLE_PARALLEL_IMPORT").is_some();
